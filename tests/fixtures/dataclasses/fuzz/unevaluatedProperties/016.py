...
class GeneratedSchema(jsoncompat_dataclasses.DataclassAdditionalModel[typing.Any]):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"dependentSchemas\":{\"foo\":{\"anyOf\":[{\"enum\":[null]},{\"enum\":[false,true]},{\"minProperties\":1,\"properties\":{\"bar\":{\"enum\":[\"bar\"]}},\"required\":[\"bar\"],\"type\":\"object\"},{\"items\":true,\"minItems\":0,\"type\":\"array\"},{\"minLength\":0,\"type\":\"string\"},{\"type\":\"number\"}]}},\"minProperties\":0,\"properties\":{\"foo\":{\"minLength\":0,\"type\":\"string\"}},\"type\":\"object\",\"unevaluatedProperties\":false}"
