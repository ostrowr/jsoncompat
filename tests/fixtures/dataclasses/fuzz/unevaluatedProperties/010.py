...
class GeneratedSchema(jsoncompat_dataclasses.DataclassAdditionalModel[typing.Any]):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"anyOf\":[{\"properties\":{\"bar\":{\"const\":\"bar\"}},\"required\":[\"bar\"]},{\"properties\":{\"baz\":{\"const\":\"baz\"}},\"required\":[\"baz\"]},{\"properties\":{\"quux\":{\"const\":\"quux\"}},\"required\":[\"quux\"]}],\"properties\":{\"foo\":{\"type\":\"string\"}},\"type\":\"object\",\"unevaluatedProperties\":false}"
