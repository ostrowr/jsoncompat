...
class GeneratedSchemaFoo(jsoncompat_dataclasses.DataclassAdditionalModel[typing.Any]):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"properties\":{\"bar\":{\"type\":\"string\"}},\"type\":\"object\",\"unevaluatedProperties\":false}"
...
class GeneratedSchema(jsoncompat_dataclasses.DataclassAdditionalModel[typing.Any]):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"anyOf\":[{\"properties\":{\"foo\":{\"properties\":{\"faz\":{\"type\":\"string\"}}}}}],\"properties\":{\"foo\":{\"properties\":{\"bar\":{\"type\":\"string\"}},\"type\":\"object\",\"unevaluatedProperties\":false}},\"type\":\"object\"}"
