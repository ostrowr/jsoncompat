...
class GeneratedSchemaBar(jsoncompat_dataclasses.DataclassAdditionalModel[typing.Any]):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$defs\":{\"bar\":{\"properties\":{\"bar\":{\"type\":\"string\"}}}},\"properties\":{\"bar\":{\"type\":\"string\"}}}"
...
class GeneratedSchema(jsoncompat_dataclasses.DataclassAdditionalModel[typing.Any]):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$defs\":{\"bar\":{\"properties\":{\"bar\":{\"type\":\"string\"}}}},\"$ref\":\"#/$defs/bar\",\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"properties\":{\"foo\":{\"type\":\"string\"}},\"type\":\"object\",\"unevaluatedProperties\":false}"
    foo: (str | jsoncompat_dataclasses.JsoncompatMissingType) = jsoncompat_dataclasses.jsoncompat_field("foo", omittable=True)
    __jsoncompat_extra__: dict[str, typing.Any] = jsoncompat_dataclasses.jsoncompat_extra_field()

GeneratedSchemaBar.__jsoncompat_object_spec__ = jsoncompat_dataclasses.jsoncompat_object_spec(
