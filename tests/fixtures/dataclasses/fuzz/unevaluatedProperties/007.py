...
class GeneratedSchema(jsoncompat_dataclasses.DataclassAdditionalModel[typing.Any]):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"allOf\":[{\"anyOf\":[{\"enum\":[null]},{\"enum\":[false,true]},{\"minProperties\":0,\"patternProperties\":{\"^bar\":{\"minLength\":0,\"type\":\"string\"}},\"properties\":{},\"type\":\"object\"},{\"items\":true,\"minItems\":0,\"type\":\"array\"},{\"minLength\":0,\"type\":\"string\"},{\"type\":\"number\"}]}],\"minProperties\":0,\"properties\":{\"foo\":{\"minLength\":0,\"type\":\"string\"}},\"type\":\"object\",\"unevaluatedProperties\":false}"
