...
class GeneratedSchemaFoo(jsoncompat_dataclasses.DataclassRootModel):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"prefixItems\":[{\"type\":\"string\"}],\"unevaluatedItems\":false}"
    root: typing.Any = jsoncompat_dataclasses.jsoncompat_root_field()

@dataclass(frozen=True, slots=True, kw_only=True)
class GeneratedSchema(jsoncompat_dataclasses.DataclassAdditionalModel[typing.Any]):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"anyOf\":[{\"properties\":{\"foo\":{\"prefixItems\":[true,{\"type\":\"string\"}]}}}],\"properties\":{\"foo\":{\"prefixItems\":[{\"type\":\"string\"}],\"unevaluatedItems\":false}}}"
