...
class GeneratedSchemaBranch2(jsoncompat_dataclasses.DataclassAdditionalModel[None]):
  ...
  "type": "object"
    ...
    __jsoncompat_extra__: dict[str, None] = jsoncompat_dataclasses.jsoncompat_extra_field()
