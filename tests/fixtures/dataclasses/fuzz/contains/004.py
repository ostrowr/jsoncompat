...
class GeneratedSchema(jsoncompat_dataclasses.DataclassRootModel):
  ...
  "items": {
    ...
    root: ((typing.Literal[False] | typing.Literal[True]) | GeneratedSchemaBranch2 | float | list[((typing.Literal[False] | typing.Literal[True]) | GeneratedSchemaBranch22 | float | list[GeneratedSchemaItem] | str | None)] | str | None) = jsoncompat_dataclasses.jsoncompat_root_field()
...
GeneratedSchema.__jsoncompat_root_annotation__ = ((typing.Literal[False] | typing.Literal[True]) | GeneratedSchemaBranch2 | float | list[((typing.Literal[False] | typing.Literal[True]) | GeneratedSchemaBranch22 | float | list[GeneratedSchemaItem] | str | None)] | str | None)
