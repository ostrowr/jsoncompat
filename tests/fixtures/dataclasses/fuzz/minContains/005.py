...
dc.bind_generated_models((
    ...
    (GeneratedSchemaBranch3, "root", typing.Any),
    (GeneratedSchema, "root", ((typing.Literal[False] | typing.Literal[True]) | GeneratedSchemaBranch2 | GeneratedSchemaBranch3 | float | str | None)),
))
