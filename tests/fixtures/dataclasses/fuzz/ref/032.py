...
class GeneratedSchema(jsoncompat_dataclasses.DataclassRootModel):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$defs\":{\"foo\":{\"type\":\"number\"}},\"$id\":\"file:///folder/file.json\",\"$ref\":\"#/$defs/foo\",\"$schema\":\"https://json-schema.org/draft/2020-12/schema\"}"
