...
class GeneratedSchemaA(jsoncompat_dataclasses.DataclassRootModel):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$defs\":{\"A\":{\"unevaluatedProperties\":false}},\"unevaluatedProperties\":false}"
    root: typing.Any = jsoncompat_dataclasses.jsoncompat_root_field()

@dataclass(frozen=True, slots=True, kw_only=True)
class GeneratedSchema(jsoncompat_dataclasses.DataclassAdditionalModel[typing.Any]):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$defs\":{\"A\":{\"unevaluatedProperties\":false}},\"$ref\":\"#/$defs/A\",\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"properties\":{\"prop1\":{\"type\":\"string\"}}}"
...
GeneratedSchemaA.__jsoncompat_root_annotation__ = typing.Any
