...
class GeneratedSchema(jsoncompat_dataclasses.DataclassAdditionalModel[typing.Any]):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$comment\":\"RFC 8141 §2.2\",\"$defs\":{\"bar\":{\"type\":\"string\"}},\"$id\":\"urn:example:1/406/47452/2\",\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"properties\":{\"foo\":{\"$ref\":\"#/$defs/bar\"}}}"
