...
class GeneratedSchema(jsoncompat_dataclasses.DataclassAdditionalModel[typing.Any]):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$comment\":\"RFC 8141 §2.3.1\",\"$defs\":{\"bar\":{\"type\":\"string\"}},\"$id\":\"urn:example:foo-bar-baz-qux?+CCResolve:cc=uk\",\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"properties\":{\"foo\":{\"$ref\":\"#/$defs/bar\"}}}"
