...
class GeneratedSchemaReffed(jsoncompat_dataclasses.DataclassRootModel):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$defs\":{\"reffed\":{\"items\":true,\"minItems\":0,\"type\":\"array\"}},\"items\":true,\"minItems\":0,\"type\":\"array\"}"
...
class GeneratedSchema(jsoncompat_dataclasses.DataclassAdditionalModel[typing.Any]):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$defs\":{\"reffed\":{\"items\":true,\"minItems\":0,\"type\":\"array\"}},\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"properties\":{\"foo\":{\"$ref\":\"#/$defs/reffed\",\"maxItems\":2}}}"
