...
class GeneratedSchema(jsoncompat_dataclasses.DataclassAdditionalModel[typing.Any]):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$defs\":{\"bar\":{\"minLength\":0,\"type\":\"string\"}},\"$id\":\"urn:uuid:deadbeef-1234-00ff-ff00-4321feebdaed\",\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"properties\":{\"foo\":{\"$ref\":\"#/$defs/bar\"}}}"
