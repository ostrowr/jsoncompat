...
class GeneratedSchema(jsoncompat_dataclasses.DataclassRootModel):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"contains\":{\"minLength\":0,\"type\":\"string\"},\"items\":true,\"maxContains\":2,\"maxItems\":3,\"minContains\":2,\"minItems\":2,\"type\":\"array\"}"
