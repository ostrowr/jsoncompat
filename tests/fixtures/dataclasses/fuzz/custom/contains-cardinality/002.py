...
class GeneratedSchema(jsoncompat_dataclasses.DataclassRootModel):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"contains\":{\"enum\":[1]},\"items\":true,\"maxContains\":0,\"minContains\":0,\"minItems\":0,\"type\":\"array\"}"
