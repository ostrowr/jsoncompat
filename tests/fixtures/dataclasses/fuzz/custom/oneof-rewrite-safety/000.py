...
class GeneratedSchemaBranch0(jsoncompat_dataclasses.DataclassModel):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"additionalProperties\":false,\"properties\":{\"kind\":{\"const\":\"int\"},\"value\":{\"type\":\"integer\"}},\"required\":[\"kind\",\"value\"],\"type\":\"object\"}"
...
class GeneratedSchemaBranch1(jsoncompat_dataclasses.DataclassModel):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"additionalProperties\":false,\"properties\":{\"kind\":{\"const\":\"str\"},\"value\":{\"type\":\"string\"}},\"required\":[\"kind\",\"value\"],\"type\":\"object\"}"
...
class GeneratedSchema(jsoncompat_dataclasses.DataclassRootModel):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"oneOf\":[{\"additionalProperties\":false,\"properties\":{\"kind\":{\"const\":\"int\"},\"value\":{\"type\":\"integer\"}},\"required\":[\"kind\",\"value\"],\"type\":\"object\"},{\"additionalProperties\":false,\"properties\":{\"kind\":{\"const\":\"str\"},\"value\":{\"type\":\"string\"}},\"required\":[\"kind\",\"value\"],\"type\":\"object\"}]}"
