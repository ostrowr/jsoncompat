...
class GeneratedSchemaTreeBranch1(jsoncompat_dataclasses.DataclassModel):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$defs\":{\"tree\":{\"oneOf\":[{\"const\":null},{\"additionalProperties\":false,\"properties\":{\"left\":{\"$ref\":\"#/$defs/tree\"},\"right\":{\"$ref\":\"#/$defs/tree\"}},\"required\":[\"left\",\"right\"],\"type\":\"object\"}]}},\"additionalProperties\":false,\"properties\":{\"left\":{\"$ref\":\"#/$defs/tree\"},\"right\":{\"$ref\":\"#/$defs/tree\"}},\"required\":[\"left\",\"right\"],\"type\":\"object\"}"
...
class GeneratedSchemaTree(jsoncompat_dataclasses.DataclassRootModel):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$defs\":{\"tree\":{\"oneOf\":[{\"const\":null},{\"additionalProperties\":false,\"properties\":{\"left\":{\"$ref\":\"#/$defs/tree\"},\"right\":{\"$ref\":\"#/$defs/tree\"}},\"required\":[\"left\",\"right\"],\"type\":\"object\"}]}},\"oneOf\":[{\"const\":null},{\"additionalProperties\":false,\"properties\":{\"left\":{\"$ref\":\"#/$defs/tree\"},\"right\":{\"$ref\":\"#/$defs/tree\"}},\"required\":[\"left\",\"right\"],\"type\":\"object\"}]}"
    root: (GeneratedSchemaTreeBranch1 | typing.Literal[None]) = jsoncompat_dataclasses.jsoncompat_root_field()

@dataclass(frozen=True, slots=True, kw_only=True)
class GeneratedSchema(jsoncompat_dataclasses.DataclassRootModel):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$defs\":{\"tree\":{\"oneOf\":[{\"const\":null},{\"additionalProperties\":false,\"properties\":{\"left\":{\"$ref\":\"#/$defs/tree\"},\"right\":{\"$ref\":\"#/$defs/tree\"}},\"required\":[\"left\",\"right\"],\"type\":\"object\"}]}},\"$ref\":\"#/$defs/tree\",\"$schema\":\"https://json-schema.org/draft/2020-12/schema\"}"
