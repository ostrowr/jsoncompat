...
class GeneratedSchema(jsoncompat_dataclasses.DataclassAdditionalModel[int]):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"additionalProperties\":{\"type\":\"integer\"},\"properties\":{\"id\":{\"type\":\"integer\"}},\"propertyNames\":{\"pattern\":\"^[a-z]+$\"},\"required\":[\"id\"],\"type\":\"object\"}"
