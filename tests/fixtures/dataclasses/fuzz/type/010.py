...
class GeneratedSchema(jsoncompat_dataclasses.DataclassRootModel):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"anyOf\":[{\"items\":true,\"minItems\":0,\"type\":\"array\"},{\"enum\":[null]},{\"minProperties\":0,\"properties\":{},\"type\":\"object\"}]}"
    root: (GeneratedSchemaBranch2 | list[GeneratedSchemaItem] | typing.Literal[None]) = jsoncompat_dataclasses.jsoncompat_root_field()
...
GeneratedSchema.__jsoncompat_root_annotation__ = (GeneratedSchemaBranch2 | list[GeneratedSchemaItem] | typing.Literal[None])
