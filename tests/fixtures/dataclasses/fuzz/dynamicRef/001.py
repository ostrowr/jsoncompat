...
class GeneratedSchemaFoo(jsoncompat_dataclasses.DataclassRootModel):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$anchor\":\"items\",\"$defs\":{\"foo\":{\"$anchor\":\"items\",\"type\":\"string\"}},\"type\":\"string\"}"
    root: str = jsoncompat_dataclasses.jsoncompat_root_field()

@dataclass(frozen=True, slots=True, kw_only=True)
class GeneratedSchemaItem(jsoncompat_dataclasses.DataclassRootModel):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$defs\":{\"foo\":{\"$anchor\":\"items\",\"type\":\"string\"}},\"$dynamicRef\":\"#items\"}"
    root: typing.Any = jsoncompat_dataclasses.jsoncompat_root_field()

@dataclass(frozen=True, slots=True, kw_only=True)
class GeneratedSchema(jsoncompat_dataclasses.DataclassRootModel):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$defs\":{\"foo\":{\"$anchor\":\"items\",\"type\":\"string\"}},\"$id\":\"https://test.json-schema.org/dynamicRef-anchor-same-schema/root\",\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"items\":{\"$dynamicRef\":\"#items\"},\"type\":\"array\"}"
