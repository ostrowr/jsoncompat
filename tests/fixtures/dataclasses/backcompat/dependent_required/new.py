...
class GeneratedSchema(jsoncompat_dataclasses.DataclassAdditionalModel[typing.Any]):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"dependentRequired\":{\"credit_card\":[\"billing_address\"]},\"properties\":{\"billing_address\":{\"type\":\"string\"},\"credit_card\":{\"type\":\"number\"}},\"type\":\"object\"}"
