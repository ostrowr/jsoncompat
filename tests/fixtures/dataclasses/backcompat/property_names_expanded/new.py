...
class GeneratedSchemaFlags(jsoncompat_dataclasses.DataclassAdditionalModel[(typing.Literal[False] | typing.Literal[True])]):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"additionalProperties\":{\"enum\":[false,true]},\"minProperties\":0,\"properties\":{},\"propertyNames\":{\"enum\":[\"a\",\"b\"]},\"type\":\"object\"}"
...
class GeneratedSchema(jsoncompat_dataclasses.DataclassAdditionalModel[typing.Any]):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"minProperties\":1,\"properties\":{\"flags\":{\"additionalProperties\":{\"enum\":[false,true]},\"minProperties\":0,\"properties\":{},\"propertyNames\":{\"enum\":[\"a\",\"b\"]},\"type\":\"object\"}},\"required\":[\"flags\"],\"type\":\"object\"}"
