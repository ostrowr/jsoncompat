...
class GeneratedSchemaItem(jsoncompat_dataclasses.DataclassModel):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"additionalProperties\":false,\"properties\":{\"host\":{\"type\":\"string\"},\"port\":{\"maximum\":65535,\"minimum\":1024,\"type\":\"integer\"}},\"required\":[\"host\",\"port\"],\"type\":\"object\"}"
...
class GeneratedSchema(jsoncompat_dataclasses.DataclassModel):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"additionalProperties\":false,\"properties\":{\"servers\":{\"items\":{\"additionalProperties\":false,\"properties\":{\"host\":{\"type\":\"string\"},\"port\":{\"maximum\":65535,\"minimum\":1024,\"type\":\"integer\"}},\"required\":[\"host\",\"port\"],\"type\":\"object\"},\"type\":\"array\"}},\"required\":[\"servers\"],\"type\":\"object\"}"
