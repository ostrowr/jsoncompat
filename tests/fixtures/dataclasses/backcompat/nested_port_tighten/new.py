...
class GeneratedSchemaItem(jsoncompat_dataclasses.DataclassModel):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"additionalProperties\":false,\"minProperties\":2,\"properties\":{\"host\":{\"minLength\":0,\"type\":\"string\"},\"port\":{\"maximum\":65535,\"minimum\":1024,\"multipleOf\":1,\"type\":\"integer\"}},\"required\":[\"host\",\"port\"],\"type\":\"object\"}"
...
class GeneratedSchema(jsoncompat_dataclasses.DataclassModel):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"$schema\":\"https://json-schema.org/draft/2020-12/schema\",\"additionalProperties\":false,\"minProperties\":1,\"properties\":{\"servers\":{\"items\":{\"additionalProperties\":false,\"minProperties\":2,\"properties\":{\"host\":{\"minLength\":0,\"type\":\"string\"},\"port\":{\"maximum\":65535,\"minimum\":1024,\"multipleOf\":1,\"type\":\"integer\"}},\"required\":[\"host\",\"port\"],\"type\":\"object\"},\"minItems\":0,\"type\":\"array\"}},\"required\":[\"servers\"],\"type\":\"object\"}"
