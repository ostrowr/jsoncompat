...
class GeneratedSchemaItem(jsoncompat_dataclasses.DataclassModel):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"additionalProperties\":false,\"minProperties\":2,\"properties\":{\"host\":{\"minLength\":0,\"type\":\"string\"},\"port\":{\"maximum\":65535,\"minimum\":0,\"multipleOf\":1,\"type\":\"integer\"}},\"required\":[\"host\",\"port\"],\"type\":\"object\"}"
