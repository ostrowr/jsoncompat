...
class GeneratedSchemaItem(jsoncompat_dataclasses.DataclassModel):
    __jsoncompat_schema__: typing.ClassVar[str] = "{\"additionalProperties\":false,\"properties\":{\"host\":{\"type\":\"string\"},\"port\":{\"maximum\":65535,\"minimum\":0,\"type\":\"integer\"}},\"required\":[\"host\",\"port\"],\"type\":\"object\"}"
